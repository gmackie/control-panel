...
export default function StarterPage() {
  const [step, setStep] = useState(0); // 0 = template selection, 1-4 = wizard steps
  const [templateType, setTemplateType] = useState<'quick-start' | 'custom' | null>(null);
        ...
        <>
          <div className="text-center mb-8">
            ...
            <p className="text-gray-400">
              Choose how you want to start your next project
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-6 max-w-4xl mx-auto">
            ...
            <Link href="/quick-start">
              <Card className="p-6 hover:border-blue-500 transition-colors cursor-pointer h-full">
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-sm text-gray-400 mb-4">
                      Production-ready monorepo with Next.js + Expo, tRPC, and pre-wired integrations
                    </p>
                    <div className="flex flex-wrap gap-2">
                      <Badge variant="outline" className="text-xs">Turso</Badge>
                      <Badge variant="outline" className="text-xs">Clerk</Badge>
                      <Badge variant="outline" className="text-xs">Stripe</Badge>
                      <Badge variant="outline" className="text-xs">PostHog</Badge>
                      <Badge variant="outline" className="text-xs">Sentry</Badge>
                    </div>
                  </div>
                </div>
            ...
            {/* Custom Build Option */}
            <Card 
              className="p-6 hover:border-blue-500 transition-colors cursor-pointer h-full"
              onClick={() => {
            ...
            >
              <div className="flex items-start gap-4">
                ...
                <div className="flex-1">
                  <h3 className="text-lg font-semibold mb-2">Custom Build</h3>
                  <p className="text-sm text-gray-400 mb-4">
                    Pick your own integrations and configure every aspect of your Next.js app
                  </p>
                  <div className="flex flex-wrap gap-2">
                    <Badge variant="outline" className="text-xs">20+ integrations</Badge>
                    <Badge variant="outline" className="text-xs">Multiple deploy targets</Badge>
                  </div>
                </div>
              </div>
              <div className="mt-4 pt-4 border-t border-gray-800">
