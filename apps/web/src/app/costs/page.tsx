...
import { PerAppCosts } from "@/components/costs/PerAppCosts";
...
export default function CostsPage() {
  ...
  return (
    <div className="max-w-7xl mx-auto p-6 space-y-6">
      ...
      {/* Main Content Tabs */}
      <Tabs defaultValue="per-app" className="space-y-4">
        <TabsList>
          <TabsTrigger value="per-app">Per Application</TabsTrigger>
          <TabsTrigger value="breakdown">Infrastructure</TabsTrigger>
          <TabsTrigger value="analytics">Usage Analytics</TabsTrigger>
          <TabsTrigger value="budgets">Budget Alerts</TabsTrigger>
          <TabsTrigger value="optimization">Optimization</TabsTrigger>
        </TabsList>

        <TabsContent value="per-app" className="space-y-4">
          <PerAppCosts />
        </TabsContent>
