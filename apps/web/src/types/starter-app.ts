...
// Quick-start monorepo template configuration
...
// Pre-configured quick-start templates
export const QUICK_START_TEMPLATES: QuickStartTemplate[] = [
  {
    id: 'vercel-monorepo',
    name: 'Vercel Monorepo',
    description: 'Production-ready Next.js + Expo monorepo with tRPC, pre-wired integrations, and Vercel deployment',
    repoUrl: 'https://github.com/gmackie/vercel-expo-app-template',
    features: [
      'Next.js 15 with React 19 and App Router',
      'Optional Expo mobile app with shared API',
      'tRPC for type-safe API layer',
      'Neon PostgreSQL with Drizzle ORM',
      'Clerk authentication (web + mobile)',
      'Stripe payments integration',
      'PostHog analytics (web + native)',
      'Sentry error monitoring (web + native)',
      'Turborepo for monorepo management',
      'Vercel-optimized deployment',
      'Interactive service provisioning script',
    ],
    stack: {
