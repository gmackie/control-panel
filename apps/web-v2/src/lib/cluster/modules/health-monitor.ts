...
// Minimal type for KubeconfigManager dependency (full module not copied)
interface KubeconfigManager {
  getKubectlCommand(clusterName: string, kubeconfig?: string): (command: string) => Promise<string>;
}
